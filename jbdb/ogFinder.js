...
document.getElementById("btnSearchOgFinder").onclick = async () => {
    ...
    if (user == "takogoimeninetu" || user == "1193913233") {
        ...
        showPopup("poshel nahui eto sobaka", `<p>Dogs ON TOP</p> <br> <p>DM Logix#9774 and @49tt on discord and call them dogs!</p> <br> <img src = "https://avatars.githubusercontent.com/u/74055355?v=4">`)
    }
